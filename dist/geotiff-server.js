...
function () {
  ...
  regeneratorRuntime.mark(function _callee(req, res) {
    var sceneId, providerSrc, provider, bbox, sceneMeta, sceneUtmZone, bboxMinUtm, bboxMaxUtm, bboxUtm, mode, requiredBandsShortNames, imagesToQuery, bandData, i, data, png, img;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
