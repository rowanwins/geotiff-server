...
function () {
  ...
  _createClass(LandsatPdsProvider, [{
    ...
    value: function constructImageUrl(sceneId, bandShortName) {
      var bandPath = null;
      ...
      return "".concat(this.baseUrl, "/").concat(path, "/").concat(row, "/").concat(sceneId, "/").concat(sceneId, "_").concat(bandPath, ".TIF");
    }
  }, {
    key: "getBandUrls",
...
// 23.1 Map Objects
var es6_map = _collection(MAP$1, function (get) {
  return function Map() { return get(this, arguments.length > 0 ? arguments[0] : undefined); };
}, {
  // 23.1.3.6 Map.prototype.get(key)
  get: function get(key) {
    var entry = _collectionStrong.getEntry(_validateCollection(this, MAP$1), key);
    return entry && entry.v;
  },
  // 23.1.3.9 Map.prototype.set(key, value)
  set: function set(key, value) {
    return _collectionStrong.def(_validateCollection(this, MAP$1), key === 0 ? 0 : key, value);
  }
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(req, res) {
    var sceneId, providerSrc, provider, bbox, sceneMeta, sceneUtmZone, bboxMinUtm, bboxMaxUtm, bboxUtm, requiredBandsShortNames, imagesToQuery, getDataCalls, i, _ref2, _ref3, r, g, b, png, img;
...
app.get('/tiles/calculate/:x/:y/:z',
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(req, res) {
    var sceneId, providerSrc, provider, bbox, sceneMeta, sceneUtmZone, bboxMinUtm, bboxMaxUtm, bboxUtm, ratio, requiredBandsShortNames, imagesToQuery, getDataCalls, i, data, dataIn, ii, png, img;
...
function _getScene() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(scene, bbox) {
    var tiff, data;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return GeoTIFF.fromUrl(scene.url);
